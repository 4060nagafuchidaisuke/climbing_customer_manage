                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="gender"
                                    ...
                                    <option value="other"  {{ old('gender', $member->gender) === 'other'  ? 'selected' : '' }}>その他</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="climbing_level"
                                        class="w-full rounded-md border-gray-300 shadow-sm text-sm
                                               focus:ring-slate-500 focus:border-slate-500">
                                    <option value="">選択してください</option>
                                    <option value="beginner"     {{ old('climbing_level', $member->climbing_level) === 'beginner'     ? 'selected' : '' }}>初心者</option>
                                    <option value="intermediate" {{ old('climbing_level', $member->climbing_level) === 'intermediate' ? 'selected' : '' }}>中級者</option>
                                    <option value="advanced"     {{ old('climbing_level', $member->climbing_level) === 'advanced'     ? 'selected' : '' }}>上級者</option>
                                </select>
                            </div>
